% -------------------------------------------------------------------------
% MAIN SCRIPT - FINAL VERSION for Genetic Algorithm (GA)
...
fprintf('Starting Crane Layout Optimization - FINAL SCENARIO (GA)\n');
...
ga_params.Pm_individual = 0.2; % Mutation probability per individual
ga_params.mutation_strength = 5; % Strength of mutation (e.g., in meters)
ga_params.elite_count = 2; % Number of elite individuals
...
fprintf('=============================================\n');
fprintf('Algorithm: Genetic Algorithm (GA)\n');
