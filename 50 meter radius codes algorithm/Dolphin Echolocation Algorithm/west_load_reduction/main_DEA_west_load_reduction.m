% -------------------------------------------------------------------------
% MAIN SCRIPT - SCENARIO: West Site Load Reduction
% Base condition: 8 Cranes, Min Distance 50m
% Change: Demand point weights (Q_j) for D9-D13 are reduced by 20%.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: West Load Reduction\n');
...
reduction_factor = 0.80; % Reduce by 20%
west_load_reduction_indices = 9:13; % Indices for D9, D10, D11, D12, D13
