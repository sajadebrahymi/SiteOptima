% -------------------------------------------------------------------------
% MAIN SCRIPT - Base Scenario with 50m Minimum Distance
% Algorithm: Dolphin Echolocation Algorithm (DEA_v2 Logic)
% Features: Measures execution time, calls separate plotting function.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: Base with Min Distance 50m\n');
...
crane_specs.min_dist_between_cranes = 50; % The key change is here!
