% -------------------------------------------------------------------------
% Dolphin Echolocation Algorithm (DEA) - FINAL VERSION
...
function [best_overall_positions, best_overall_fitness, fitness_history] = ...
    ...
    if ~isempty(best_overall_fitness) && ~isinf(best_overall_fitness)
        ...
        warning('Initial population yielded no valid solutions (all fitness values are Inf). Check constraints.');
    end
    
    fprintf('Running Dolphin Echolocation Algorithm...\n');
