% -------------------------------------------------------------------------
% MAIN SCRIPT - SCENARIO: Site Width Reduction
% Base condition: 8 Cranes, Min Distance 50m
% Change: Site Y-dimension (length) is reduced to 60m.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: Site Width Reduction (Y=60m)\n');

% --- 1. Problem Definition ---
site_dims.width = 250; 
% ******** خط کلیدی که تغییر کرده است ********
site_dims.length = 60;  % <-- عرض سایت به 60 متر کاهش یافت
% *******************************************
...
fprintf('Scenario: Site Width Reduction (Y=60m)\n');
