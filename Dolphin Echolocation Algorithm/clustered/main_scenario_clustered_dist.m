% -------------------------------------------------------------------------
% MAIN SCRIPT for Crane Layout Optimization - SCENARIO: CLUSTERED DISTRIBUTION
% Based on "Base Scenario" (v2 with explicit decay params)
% Changes:
%   - Number of cranes: 8
%   - Demand point weights (Q_j) modified to simulate clustering.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: CLUSTERED DISTRIBUTION\n');
...
% Demand Points (D_j) [x, y, z_d, Q_j_tonnes] - Initial Definition
...
% --- Modify demand point weights for Clustered Distribution Scenario ---
...
problem.num_demand_points = num_demand_points; % Number of points remains the same
...
fprintf('  Scenario: Clustered Distribution\n');
...
% --- Results ---
fprintf('Optimization Finished for Clustered Distribution Scenario.\n');
