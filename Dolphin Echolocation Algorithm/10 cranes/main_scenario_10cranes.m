% -------------------------------------------------------------------------
% MAIN SCRIPT for Crane Layout Optimization - SCENARIO: 10 CRANES
% Based on "Base Scenario" (v2 with explicit decay params)
% Change: Number of cranes increased to 10.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: 10 CRANES\n');
...
% ******** KEY CHANGE HERE ********
crane_specs.num_cranes = 10; % <--- Changed from base (e.g. 8) to 10
% ***********************************
...
% --- Results ---
fprintf('Optimization Finished for 10-Crane Scenario.\n');
