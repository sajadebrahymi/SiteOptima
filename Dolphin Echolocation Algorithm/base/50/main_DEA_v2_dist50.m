% -------------------------------------------------------------------------
% MAIN SCRIPT for Crane Layout Optimization - NEW SCENARIO
% Change: Minimum distance between cranes set to 50 meters.
% -------------------------------------------------------------------------
clear;
close all;
clc;

fprintf('Starting Crane Layout Optimization - SCENARIO: Min Distance 50m\n');
...
crane_specs.min_dist_between_cranes = 50; % <-- حداقل فاصله به 50 متر افزایش یافت
% *******************************************
crane_specs.tower_height = 65; % ارتفاع برج جرثقیل برای نمایش سه‌بعدی

% --- DEA v2 Algorithm Parameters (Same as Base Scenario) ---
dea_params.Npop = 50; 
dea_params.Tmax = 200; 
